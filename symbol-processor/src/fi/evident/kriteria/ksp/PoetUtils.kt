...
internal fun attributeOverrides(vararg overrides: Pair<String, String>): AnnotationSpec {
...
internal fun columnAnnotation(name: String): AnnotationSpec =
    AnnotationSpec.builder(Column::class).addMember("name = %S", name).build()

internal fun manyToOne(name: String, type: ClassName, initializer: String? = null): PropertySpec {
