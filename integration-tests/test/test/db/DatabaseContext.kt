...
internal class DatabaseContext(val emf: EntityManagerFactory)

context(db: DatabaseContext)
internal inline fun <T> transactionally(block: context(Tx) () -> T): T {
...
context(tx: Tx)
internal inline fun <reified T : Any> evaluateExpression(crossinline build: context(KrExpressionContext) () -> KrExpression<out T?>): T? =
